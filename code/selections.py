...
select_verbs_map = {
  ...
  "comment": [actions.user.toggle_comment], 
  ...
  "rename": [actions.user.ide_refactor_name], 
...
mod.tag('line_commands', desc='Tag for enabling generic line nav and selection commands')
...
class Actions:
  ...
  def select_line(verb: str, line: int):
    """ Perform action on selection of specified line """
    actions.edit.go_to_line(line)
    actions.edit.extend_line_end()
    perform_selection_action(verb)    

  def select_until_line(verb: str, line: int):
    """ Perform action on selection from current line to the specified line """

  def select_range(verb: str, line_start: int, line_end: int):
    """ Perform action on selection from line_start to line_end"""
    actions.edit.go_to_line(line_start)
    actions.edit.extend_line_end()    
  ...
  def select_way_left(verb: str):
    """ Perform action on selection from cursor to line start """
    actions.edit.extend_line_start()
    perform_selection_action(verb)    

  def select_way_right(verb: str):
    """ Perform action on selection from cursor to line end """
    actions.edit.extend_line_end()
    perform_selection_action(verb)       

  def select_way_up(verb: str):
    """ Perform action on selection from cursor to file start """
    actions.edit.extend_file_start()
    perform_selection_action(verb)       
  
  def select_way_down(verb: str):
    """ Perform action on selection from cursor to file end """
  ...
  def move_camel_left(verb: str):
    """ Move and perform action on camel left """

  def move_camel_right(verb: str):
    """ Move and perform action on camel right """
