...
default_f_digits = 'one two three four five siz seven eight nine ten eleven twelve'.split(' ')
...
@ctx.capture(rule='(<self.arrow> | <self.number> | <self.letter> | <self.symbol> | <self.special>)')
def any(m) -> str:
  return str(m)
