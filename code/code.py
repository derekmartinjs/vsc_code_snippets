...
mod.tag("code_comment", desc="Tag for enabling generic code commands")
mod.tag("code_block_comment", desc="Tag for enabling generic block comments")
...
class Actions:
  ...
  def code_operator_left_shift():
    """code_operator_bitwise_left_shift"""

  def code_operator_left_shift_assignment():
    """code_operator_bitwise_left_shift_assignment"""

  def code_operator_right_shift():
    """code_operator_bitwise_right_shift"""

  def code_operator_right_shift_assignment():
  ...
  def code_state_for_each():
    """Inserts for each equiv statement"""

  def code_state_go_to():
    """Inserts goto statement"""
  ...
  def code_insert_library(number: int, selection: str):
